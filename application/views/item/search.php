...
<div class="container box">
	<div class="table-responsive">
		...
		<table id="sender_info111" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th id="proformaRef" colspan="2"> <?php
					echo $_SESSION['refer_number'];
        ...
        $totalAmount=0;
			...
			<tr>
				...
				<td><?php echo $profile->p_customer?></td>
        ...
        <td><?php echo $profile->quantity?></td>
			...
			?>
      <tr><td colspan="5">Total Amount</td><td><?php if($profiles) echo $totalAmount?></td></tr>
		</table>
