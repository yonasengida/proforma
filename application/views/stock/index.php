...
<button data-toggle="modal" data-target="#stckin-modal" data-id="" id="createUser" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-user"></i>Stock In</button>
<button data-toggle="modal" data-target="#stckin-modal" data-id="" id="createUser" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-user"></i>Stock Out</button>
</div>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-header">
             ...
             <i class="glyphicon glyphicon-user"></i>Update Stock
             </h4>
         </div>
  ...
  <div class="table-responsive">
    <table id="sender_info" class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <td><?php echo $profile->item_id?></td>
        <td><?php echo $profile->stock_amount?></td>
      <td><?php echo $profile->stock_type?></td>
      <td>
        <!-- <a href="" class=" btn btn-info">Edit</a> -->
        <button data-toggle="modal" data-target="#update-modal" data-id="<?php echo $profile->stocks_id?>" id="getCustomer" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-update"></i>Update</button>
      </td>
...
<form id= "crate_user" action="<?php echo base_url()?>stock/create" method="POST">
<!--Modal-->
<div id="stckin-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-header">
             <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
             <h4 class="modal-title">
             <i class="glyphicon glyphicon-user"></i>Stock In
             </h4>
         </div>
       ...
       <div class="modal-footer">
         <button id="1" type="submit" class="btn btn-success" >Stock In</button>
