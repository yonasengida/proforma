...
<div class="container box">
 ...
 <center><img src="<?php echo base_url("assets/images/micro_header.jpg");?>" class="img-responsive"></center>
	...
	<div class="table-responsive">
		<h3>Todays Payment Summary Report</h3>
		<table id="sender_info1" class="table table-bordered table-striped">
			...
			<!-- <td>
			<button data-toggle="modal" data-target="#view-modal1" data-id="<?php echo $profile->transfer_money_id?>" id="getPay" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-update"></i>Cancel Payement</button>
			</td> -->
