...
<div class="container box">
	<div class="table-responsive">
		<table id="sender_info" class="table table-bordered table-striped">
			...
			<td>
			<button data-toggle="modal" data-target="#view-modal" data-id="<?php echo $profile->transfer_money_id?>" id="getPay" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-update"></i>Pay</button>
			</td>
